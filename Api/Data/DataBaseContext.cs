    ...
    public class DataBaseContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Categoria>().HasData(
                new Categoria() {CategoriaId = 1, Nome = "Plantas", Interior = true},
                new Categoria() {CategoriaId = 2, Nome = "Plantas", Exterior = true});
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=(localdb)\MSSQLLocalDB; Database=SitePlantasDB; Trusted_Connection=True");
        }
